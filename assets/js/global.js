...
document.addEventListener("DOMContentLoaded", function() {
  const e = document.body,
    t = document.getElementById("widgets"),
    n = document.getElementById("widget-tags"),
    d = document.getElementById("widget-content"),
    o = document.getElementById("pinned"),
    c = document.querySelector(".pinned-wrap > div"),
    i = document.getElementById("related"),
    s = document.querySelector(".post-related-section .special-section-content"),
    l = document.getElementById("icons"),
    a = document.getElementsByTagName("a").length,
    m = document.getElementById("toggle"),
    r = document.querySelector(".header-nav-dropdown"),
    u = document.querySelectorAll(".header-checkbox:checked"),
    g = document.getElementById("back-to-top");
  if (e.classList.add("is-loaded"), r && (r.addEventListener("click", function() {
      r.classList.toggle("is-active")
    }), document.addEventListener("click", function(e) {
      e.target.closest(".header-nav-dropdown") || r.classList.remove("is-active")
    })), t && (d || n.remove()), o && (c || o.remove()), i && (s || i.remove()), l.classList.add("items-" + a), u) {
    const e = window.matchMedia("(min-width: 1024px)");
    e.addListener(w), w(e)
  }

  function w(e) {
    e.matches && (m.checked = !1)
  }
  if (g) {
    window.addEventListener("scroll", function() {
      window.scrollY > 1500 ? g.classList.add("is-show") : g.classList.remove("is-show")
